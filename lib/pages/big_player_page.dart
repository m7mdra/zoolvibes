...
enum RepeatMode { List, Single, Loop }

class _BigPlayerPageState extends State<BigPlayerPage>
    with SingleTickerProviderStateMixin {
  var favorite = false;
  bool isOpened = false;
  var currentRepeatMode = RepeatMode.Loop;
  var currentRepeatIcon = Icons.repeat;
  var repeateModes = [RepeatMode.List, RepeatMode.Loop, RepeatMode.Single];
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      print(currentRepeatMode);
                      setState(() {
                        switch (currentRepeatMode) {
                          case RepeatMode.List:
                            currentRepeatIcon = Icons.repeat;
                            currentRepeatMode = RepeatMode.Loop;
                            break;
                          case RepeatMode.Loop:
                            currentRepeatIcon = Icons.repeat_one;
                            currentRepeatMode = RepeatMode.Single;
                            break;
                          case RepeatMode.Single:
                            currentRepeatIcon = Icons.list;
                            currentRepeatMode = RepeatMode.List;
                            break;
                        }
